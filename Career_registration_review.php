	  ...
	  <center>
		  <div style="border-style:grrove; border-color: darkblue">
		    <table border="1" width="700px" border="1px" style="width:700px; line-height:50px;>
			 ...
			 <tr>
               <th border= "1px" colspan="8"><h2>Career registration details</h2></th>
	         </tr>
			 <tr>
			    <th class="col1">career id</th>
				<th class="col1">Name</th>
                <th class="col1">telephone</th>
                <th class="col1">E-mail</th> 
                <th class="col1">Designation</th>   				
			 </tr>
			   <?php
				...
				if($result->num_rows>0){
						...
						while($row=$result->fetch_assoc()){
							echo "<tr><td>".$row["career_id"]."</td><td>".$row["c_name"]."</td><td>".$row["c_telephone"]."</td><td>".$row["email"]."</td> <td>".$row["career_des"]."</td></tr>";  
						} 
